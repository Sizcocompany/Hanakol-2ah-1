...
//
//                        Meals meals = new Meals(mealDescription, uri.toString(), mealName, mealRate, mealSteps, onGetOwnerName() , mealCreationDate , onGetOwnerEmail());
////
////                        CollectionReference notebookRef = db.collection("meals-database").document(child).collection("data");
////
